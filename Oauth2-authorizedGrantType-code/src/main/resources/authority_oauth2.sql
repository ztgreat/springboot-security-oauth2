...
Source Database       : authority_oauth2

Target Server Type    : MYSQL
Target Server Version : 50615
File Encoding         : 65001

Date: 2019-01-04 14:03:26
*/
...
CREATE TABLE `oauth_client` (
  ...
  `authorities` varchar(256) DEFAULT NULL COMMENT '角色，和sys_role表相关联',
...
-- ----------------------------
INSERT INTO `oauth_client` VALUES ('client_1', 'ALL', '{bcrypt}$2a$10$t6pHuvug3fE0gygmpdpUXePgJ49FmdR7pLypBLa2kQbp9U2BsAdWO', 'select', 'client_credentials,refresh_token', null, 'ROLE_ADMIN', null, null, null, null);
INSERT INTO `oauth_client` VALUES ('client_2', 'ALL', '{bcrypt}$2a$10$wu4Kc6STrCeAuAoWDQ3OM.X2MJ9.PMHpTBXxq5.JiMNYEB4cAcOwa', 'select,get', 'authorization_code,refresh_token,implicit', 'http://baidu.com', 'ROLE_ADMIN', null, null, null, null);
...
INSERT INTO `sys_permission` VALUES ('184', 'OAuth2认证', '#', '1', 'Oauth2认证', '0', '0');
INSERT INTO `sys_permission` VALUES ('185', '认证', '/oauth/authorize', '1', '认证', '1', '184');
...
INSERT INTO `sys_role_permission` VALUES ('217', '1', '184');
INSERT INTO `sys_role_permission` VALUES ('218', '1', '185');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', 'admin', 'admin', 'admin@shop.com', '12345678958', '$2a$10$rnucbc1b5mCUAJU9Rav8GOWn3eI000uxzGDPkY1.dgrXBqekybKVO', '2017-06-16 11:15:33', '2018-07-20 14:36:26', '2018-10-08 15:53:09', '1');
